...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Toast error = Toast.makeText(getContext(), "Introduce una IP válida", Toast.LENGTH_SHORT);

        String serverKey = getString(R.string.pref_server_key);
        if (preference.getKey().equals(serverKey)) {
            String ipStr = (String) newValue;
            if(!validate(ipStr)){
                error.show();
                return false;
            }
